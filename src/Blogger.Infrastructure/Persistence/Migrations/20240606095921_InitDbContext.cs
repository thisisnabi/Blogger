        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Author_FullName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Author_Avatar = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: false),
                    Author_JobTitle = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    ...
                    ReadOnTimeSpan = table.Column<TimeSpan>(type: "time", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Likes", x => new { x.ArticleId, x.Id });
                    table.ForeignKey(
