...
public class BloggerDbContextFactory(IPublisher publisher) : IDesignTimeDbContextFactory<BloggerDbContext>
{
    public BloggerDbContext CreateDbContext(string[] args)
    {
        ...
        return new BloggerDbContext(optionBuilder.Options, publisher);
    }
}
