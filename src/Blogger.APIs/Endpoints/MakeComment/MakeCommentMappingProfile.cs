...
public class ReplayToCommetMappingProfile : IRegister
{
    public void Register(TypeAdapterConfig config)
    {
        config.ForType<ReplayToCommetRequest, MakeCommentCommand>()
        ...
        config.ForType<MakeCommentCommandResponse, ReplayToCommetResponse>()
